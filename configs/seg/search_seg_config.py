...
def get_config(ceph_path="/ceph_ai", mode="train", branch="develop"):
    ...
    class Config():
        ...
        class data_config():
            ...
            class seg_data():
                task_id = 1
                tags_paths=["/ceph/tools/segnet/data/conll_format/train_dir/"]
                train_paths=["/ceph/tools/segnet/data/conll_format/train_dir/_{}".format(i) for i in range(100)]
                dev_paths=["/ceph/tools/segnet/data/conll_format/train_dir/_1"]
                test_paths=["/ceph/tools/segnet/data/conll_format/train_dir/_1"]
