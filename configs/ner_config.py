...
def get_config(ceph_path="/ceph_ai", mode="train", branch="test"):
    ...
    class Config():
        ...
        dev_paths=[ceph_path + "/xiahong/data/ner_data/dev.data"]
        ...
        _chars_vec=Vec(
            vec_path=ceph_path+'/xiahong/data/seq_tag/char_vec.txt',
            trainable=True,
            vocab_path=ceph_path+'/xiahong/data/seq_tag/char_vec.txt',
        ...
        tm=now()
        model_dir=ceph_path+'/xiahong/RESULT/ner/{}/{}-model'.format(branch, tm)+suffix
        summary_dir=ceph_path+'/xiahong/RESULT/ner/{}/{}-log'.format(branch, tm)+suffix
