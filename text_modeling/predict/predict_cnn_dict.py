    ...
    def __init__(self, ):
        ...
        self.tags = tags = {
            ...
            word in enumerate(
                open(tags_path))}
        words = {
            k - 1: word.split()[0] for k,
            word in enumerate(
                open(words_path)) if k >= 1 and k < 200000}
        self.seq_p = sequence_line_processing(
            words, return_length=False, max_len=200, split="char")
